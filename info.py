...
PICS = (environ.get('PICS', 'https://graph.org/file/ddd8de39b2c2837a17fbb-71c203d52bb4a6e9d7.jpg')).split()  # Sample pic
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/e6c8c517ee3f42d5d772e-331533c6320d361b70.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://graph.org/file/60e8a622b14796e4448ce.mp4")
SPELL_IMG = environ.get("SPELL_IMG", "https://graph.org/file/13702ae26fb05df52667c.jpg")
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://graph.org/file/a80b46af513328c7cf1c3-5b8aa5baf1f54f95b5.jpg'))
FSUB_PICS = (environ.get('FSUB_PICS', 'https://graph.org/file/a80b46af513328c7cf1c3-5b8aa5baf1f54f95b5.jpg')).split()  # Fsub pic

# ============================
# Admin, Channels & Users Configuration
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6046055058').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002409171321').split()]  # Channel id for auto indexing (make sure bot is admin)
...
DEENDAYAL_MOVIE_UPDATE_CHANNEL = int(environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL', '-1002331090517'))  # Notification of those who verify will be sent to your channel
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002350369630'))  # Premium logs channel id
auth_channel = environ.get('AUTH_CHANNEL', '-1002260068200')  # Channel/Group ID for force sub (make sure bot is admin)
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002441587926').split()]
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002459015261')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002359536802')  # Request channel id (make sure bot is admin)
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1002260068200').split()]
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1002285505798').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)
...
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'lamasandeep821@okicici')
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'https://t.me/SANDY_FILES')
...
DEENDAYAL_VERIFIED_LOG = int(environ.get('DEENDAYAL_VERIFIED_LOG', '-1002266498646'))  # Log channel id (make sure bot is admin)
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/+URI0ggQ1mLAyM2Y1')  # How to open tutorial link for verification
